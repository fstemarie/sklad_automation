...
set src "/l/backup/qbittorrent" # Variable qui contient le chemin du dossier de sauvegarde
set dst "/l/containers/qbittorrent" # Variable qui contient le chemin du dossier de destination
