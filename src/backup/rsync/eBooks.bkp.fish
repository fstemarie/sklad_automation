...
set src "/d/ruby/eBooks" # Variable qui contient le chemin du dossier à sauvegarder
set dst "francois@rsync.filelu.com:/" # Variable qui contient le chemin du dossier de destination où les sauvegardes seront stockées
set log "/var/log/automation/eBooks.rsync.tar.log" # Variable qui contient le chemin du fichier de log où les messages d'information et d'erreur seront enregistrés
