...
set dst "francois@rsync.filelu.com:/backup/mirror" # Variable qui contient le chemin du dossier de destination où les sauvegardes seront stockées
set log "/var/log/automation/mirror.rsync.bkp.log" # Variable qui contient le chemin du fichier de log où les messages d'information et d'erreur seront enregistrés
